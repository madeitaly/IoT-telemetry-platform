...
export type GetTelemetryAggregateType<T extends TelemetryAggregateArgs> = {
    [P in keyof T & keyof AggregateTelemetry]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateTelemetry[P]> : Prisma.GetScalarType<T[P], AggregateTelemetry[P]>;
};
...
type GetTelemetryGroupByPayload<T extends TelemetryGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<TelemetryGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof TelemetryGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], TelemetryGroupByOutputType[P]> : Prisma.GetScalarType<T[P], TelemetryGroupByOutputType[P]>;
}>>;
export type TelemetryWhereInput = {
    ...
    deviceId?: Prisma.IntFilter<"Telemetry"> | number;
    ts?: Prisma.DateTimeFilter<"Telemetry"> | Date | string;
    payload?: Prisma.JsonFilter<"Telemetry">;
    temperature?: Prisma.FloatNullableFilter<"Telemetry"> | number | null;
    humidity?: Prisma.FloatNullableFilter<"Telemetry"> | number | null;
    battery?: Prisma.FloatNullableFilter<"Telemetry"> | number | null;
...
export type TelemetryScalarWhereWithAggregatesInput = {
    ...
    deviceId?: Prisma.IntWithAggregatesFilter<"Telemetry"> | number;
    ts?: Prisma.DateTimeWithAggregatesFilter<"Telemetry"> | Date | string;
    payload?: Prisma.JsonWithAggregatesFilter<"Telemetry">;
    temperature?: Prisma.FloatNullableWithAggregatesFilter<"Telemetry"> | number | null;
    humidity?: Prisma.FloatNullableWithAggregatesFilter<"Telemetry"> | number | null;
    battery?: Prisma.FloatNullableWithAggregatesFilter<"Telemetry"> | number | null;
};
...
export type TelemetryOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "deviceId" | "ts" | "payload" | "temperature" | "humidity" | "battery", ExtArgs["result"]["telemetry"]>;
...
export type TelemetryCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<TelemetryFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface TelemetryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['Telemetry'];
        meta: {
            name: 'Telemetry';
        };
    };
     ...
     * })
    **/
    count<T extends TelemetryCountArgs>(args?: Prisma.Subset<T, TelemetryCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], TelemetryCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends TelemetryGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, TelemetryGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTelemetryGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface TelemetryFieldRefs {
    ...
    readonly deviceId: Prisma.FieldRef<"Telemetry", 'Int'>;
    readonly ts: Prisma.FieldRef<"Telemetry", 'DateTime'>;
    readonly payload: Prisma.FieldRef<"Telemetry", 'Json'>;
    readonly temperature: Prisma.FieldRef<"Telemetry", 'Float'>;
    readonly humidity: Prisma.FieldRef<"Telemetry", 'Float'>;
    readonly battery: Prisma.FieldRef<"Telemetry", 'Float'>;
}
/**
